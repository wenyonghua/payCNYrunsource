var platformVM = new Vue({
	...
	methods : {
		...
		modifyLoginPwd : function() {//修改登录密码
			var that = this;
		...
		addMerchant : function() {
			...
			if (editMerchant.ipWhitelist === null || editMerchant.ipWhitelist === '') {
				layer.alert('请输入IP白名单', {
					title : '提示',
					icon : 7,
					time : 3000
				});
