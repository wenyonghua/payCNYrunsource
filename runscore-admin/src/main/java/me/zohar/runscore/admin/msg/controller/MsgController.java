...
public class MsgController {
	...
	public Result findTodoMsg() {
		...
		map.put("recharge", recharge);//申诉列表
		map.put("withdraw", withdraw);//充值列表
		map.put("appeal", appeal);//提现
		map.put("settlement", settlement);//接算
		map.put("auditGatheringCode", auditGatheringCode);//审核收款码
