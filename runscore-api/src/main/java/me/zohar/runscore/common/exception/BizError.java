...
public enum BizError {
	...
	内部转账没有查询到数据("1014", "内部转账没有查询到数据"),

	邀请码不存在或已失效("1014", "邀请码不存在或已失效"),
	商户订单号已存在请重新输入商户订单号("1014","商户订单号已存在,请重新输入商户订单号"),
	...
	代付没有接单人员进行接单("1015", "代付没有接单人员进行接单"),
	代付没有接单人员进行接单或者接单状态没有启用("1015", "代付没有接单人员进行接单或者接单状态没有启用"),

	代付没有接单人员付款标记没有付款人员("1015", "代付没有接单人员付款标记没有付款人员"),
	...
	系统接过次单请等3分钟在接这个订单("1015", "系统接过次单请等3分钟在接这个订单"),
	不能重复点击("1015", "不能重复点击 Do not click repeatedly"),

	不能重复点击确认支付请3分钟以后在点击("10199", "不能重复点击确认支付,请3分钟以后在点击,You cannot click repeatedly to confirm payment, please click after 3 minutes"),
	
	保证金不足("1014", "保证金不足"),
	
	可提现金额不足("1014", "可提现金额不足"),

	商户可提现金额不足("1014", "商户可提现金额不足"),
	...
	收款的银行卡不对请重新输入("1014", "收款的银行卡不对请重新输入The bank card received is incorrect, please re-enter"),
	输入的提现额度大于卡的总额度请从新输入额度("1014", "输入的提现额度大于卡的总额度请从新输入额度"),
	请输入提现额度("1014", "请输入提现额度"),
	不能添加相同的收款卡("1014", "不能添加相同的收款卡"),
	请输入正确数据("1014", "请输入正确数据"),
	输入的银行卡是存款卡不能内部转账("1014", "输入的银行卡是存款卡不能内部转账"),
	输入的收款银行卡和出款卡一直请重新输入("1014", "输入的收款银行卡和出款卡一直请重新输入"),
	付款的银行卡不对请重新输入("1014", "付款的银行卡不对请重新输入"),
	付款的银行卡余额不足请重新更换银行卡("1014", "付款的银行卡余额不足请重新更换银行卡"),
	必须填写备注信息("1014", "必须填写备注信息"),
	输入的手续费不对必须是数字("1014", "输入的手续费不对必须是数字"),
	商户提现额度金额不对必须是数字("1014", "商户提现额度金额不对必须是数字"),
	IP白名单不在配置里面("1015", "IP白名单不在配置里面"),
	输入的付款金额不对必须是数字("1014", "输入的付款金额不对必须是数字"),

	输入的数据不对("1014", "输入的数据不对请重新输入"),
	没有付款银行卡("1014", "没有付款银行卡"),
	付款总金额和提现金额不一致("1014", "付款总金额和提现金额不一致"),
	;
	private String code;
