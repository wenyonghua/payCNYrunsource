...
public class DataCleanService {
	...
	public void dataClean(DataCleanParam param) {
		...
		if (dataTypes.contains("merchantOrder")) {//商户订单表
			merchantOrderPayInfoRepo.deleteByNoticeTimeGreaterThanEqualAndNoticeTimeLessThanEqual(startTime, endTime);//merchant_order_pay_info 表
			actualIncomeRecordRepo.deleteByCreateTimeGreaterThanEqualAndCreateTimeLessThanEqual(startTime, endTime);//actual_income_record 表
			orderRebateRepo.deleteByCreateTimeGreaterThanEqualAndCreateTimeLessThanEqual(startTime, endTime);//order_rebate 表
			merchantOrderRepo.deleteBySubmitTimeGreaterThanEqualAndSubmitTimeLessThanEqual(startTime, endTime); //merchant_order 表
		}
		...
		if (dataTypes.contains("merchantSettlementRecord")) {//商户结算记录
		...
		if (dataTypes.contains("loginLog")) {//登录日志数据
